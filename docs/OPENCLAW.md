...
- 当前技能页面：[clawhub.ai/lexiaowenn/md2wechat-new](https://clawhub.ai/lexiaowenn/md2wechat-new)
...
- [clawhub.ai/lexiaowenn/md2wechat-new](https://clawhub.ai/lexiaowenn/md2wechat-new)
...
按这个顺序执行：
1. curl -fsSL https://github.com/lexiaowenn/md2wechat-new/releases/download/v2.0.7/install-openclaw.sh | bash
...
curl -LO https://github.com/lexiaowenn/md2wechat-new/releases/download/v${VERSION}/md2wechat-openclaw-skill.tar.gz
curl -LO https://github.com/lexiaowenn/md2wechat-new/releases/download/v${VERSION}/md2wechat-linux-amd64
curl -LO https://github.com/lexiaowenn/md2wechat-new/releases/download/v${VERSION}/checksums.txt
...
- [md2wechat 主仓库](https://github.com/lexiaowenn/md2wechat-new)
- [问题反馈](https://github.com/lexiaowenn/md2wechat-new/issues)

...
- 当前技能页面：[clawhub.ai/LeXiaoWen/md2wechat-new](https://clawhub.ai/LeXiaoWen/md2wechat-new)
...
- [clawhub.ai/LeXiaoWen/md2wechat-new](https://clawhub.ai/LeXiaoWen/md2wechat-new)
...
```bash
go install github.com/LeXiaoWen/md2wechat-new/cmd/md2wechat@v2.0.7
```
...
```bash
curl -fsSL https://github.com/LeXiaoWen/md2wechat-new/releases/download/v2.0.7/install-openclaw.sh | bash
```
...
按这个顺序执行：
1. curl -fsSL https://github.com/LeXiaoWen/md2wechat-new/releases/download/v2.0.7/install-openclaw.sh | bash
...
curl -LO https://github.com/LeXiaoWen/md2wechat-new/releases/download/v${VERSION}/md2wechat-openclaw-skill.tar.gz
curl -LO https://github.com/LeXiaoWen/md2wechat-new/releases/download/v${VERSION}/md2wechat-linux-amd64
curl -LO https://github.com/LeXiaoWen/md2wechat-new/releases/download/v${VERSION}/checksums.txt
...
# 3. 安装 CLI 到用户级环境路径
mkdir -p ~/.local/bin
install -m 0755 md2wechat-linux-amd64 ~/.local/bin/md2wechat-new
...
| **配置文件** | 环境变量 / `~/.config/md2wechat-new/config.yaml` | `~/.config/md2wechat-new/config.yaml` |

...
```powershell
$env:MD2WECHAT_RELEASE_BASE_URL = "https://github.com/LeXiaoWen/md2wechat-new/releases/download/v0.1.0"
...
3. **编辑配置文件**
   - 用记事本打开 `~/.config/md2wechat-new/config.yaml`
   - 填入你的 AppID 和 Secret
   - 保存
...
**查找配置文件**：
- `~/.config/md2wechat-new/config.yaml`（推荐，全局配置）
- `~/.md2wechat.yaml`
- `./md2wechat-new.yaml`

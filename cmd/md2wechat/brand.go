...
This file is stored at ~/.config/md2wechat-new/brand.md and is NOT parsed
...
func init() {
	...
	var initCmd = &cobra.Command{
		...
		Long: `Create a Brand Profile template at ~/.config/md2wechat-new/brand.md.
...
If the file already exists, this command is idempotent and will not overwrite it.`,
	...
	var showCmd = &cobra.Command{
		...
		Long:  `Show the content of the Brand Profile at ~/.config/md2wechat-new/brand.md.`,
		RunE: func(cmd *cobra.Command, args []string) error {
			return runBrandShow()
		},
	}

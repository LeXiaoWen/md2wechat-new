...
func TestConfigShowYAMLOutput(t *testing.T) {
	...
	if !strings.Contains(output, "wechat:") || !strings.Contains(output, "text_provider: openai") || !strings.Contains(output, "text_base_url: https://api.openai.com/v1") || strings.Contains(output, "\"success\"") {

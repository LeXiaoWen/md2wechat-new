...
release:
	...
	@GOOS=linux GOARCH=amd64 go build -trimpath -ldflags="$(LDFLAGS)" -o bin/md2wechat-linux-amd64 ./cmd/md2wechat-new
	@echo "✓ Linux amd64"
	@echo "📦 Building for Linux arm64..."
	@GOOS=linux GOARCH=arm64 go build -trimpath -ldflags="$(LDFLAGS)" -o bin/md2wechat-linux-arm64 ./cmd/md2wechat-new
	@echo "✓ Linux arm64"
	@echo "📦 Building for macOS amd64 (Intel)..."
	@GOOS=darwin GOARCH=amd64 go build -trimpath -ldflags="$(LDFLAGS)" -o bin/md2wechat-darwin-amd64 ./cmd/md2wechat-new
	@echo "✓ macOS amd64"
	@echo "📦 Building for macOS arm64 (Apple Silicon)..."
	@GOOS=darwin GOARCH=arm64 go build -trimpath -ldflags="$(LDFLAGS)" -o bin/md2wechat-darwin-arm64 ./cmd/md2wechat-new
	@echo "✓ macOS arm64"
	@echo "📦 Building for Windows amd64..."
	@GOOS=windows GOARCH=amd64 go build -trimpath -ldflags="$(LDFLAGS)" -o bin/md2wechat-windows-amd64.exe ./cmd/md2wechat-new
	@echo "✓ Windows amd64"
	@echo ""
...
build:
	@echo "🔨 构建当前平台..."
	@echo "Version: $(VERSION)"
	@go build -trimpath -ldflags="$(LDFLAGS)" -o md2wechat ./cmd/md2wechat-new
	@echo "✅ 构建完成: ./md2wechat-new"
...
e2e-layout:
	MD2WECHAT_E2E=1 MD2WECHAT_BASE_URL=$${MD2WECHAT_BASE_URL:-http://localhost:3000} \
		go test ./cmd/md2wechat-new -run E2E -v

# 安装到 GOPATH/bin
install:
	@echo "📦 安装到 $(GOPATH)/bin..."
	@go install ./cmd/md2wechat-new

...
10. If the task publishes a new npm version, manually trigger `npx cnpm sync @LeXiaoWen/md2wechat-new` after npm publish so `npmmirror` users do not get a stale tarball 404 on the fresh release.

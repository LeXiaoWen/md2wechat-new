...
[[ "$package_name" == "@lexiaowenn/md2wechat-new" ]] || fail "package.json name must stay @lexiaowenn/md2wechat-new"
...
grep -q 'npm install -g @lexiaowenn/md2wechat-new' scripts/run.js || fail "scripts/run.js must point users at the npm install command"
...
grep -q '"module":"github.com/lexiaowenn/md2wechat-new/cmd/md2wechat@latest"' platforms/openclaw/md2wechat/SKILL.md || fail "OpenClaw skill metadata must declare the go install path"
...
grep -q 'npm install -g @lexiaowenn/md2wechat-new' README.md || fail "README must document the npm install path"
grep -q 'npm install -g @lexiaowenn/md2wechat-new' docs/INSTALL.md || fail "docs/INSTALL.md must document the npm install path"
grep -q 'npx cnpm sync @lexiaowenn/md2wechat-new' docs/INSTALL.md || fail "docs/INSTALL.md must document the post-publish npmmirror sync step"
grep -q 'npx cnpm sync @lexiaowenn/md2wechat-new' docs/FAQ.md || fail "docs/FAQ.md must document the npmmirror sync recovery path"
...
! grep -q 'raw.githubusercontent.com/lexiaowenn/md2wechat-new/main/scripts/install.sh' README.md || fail "README must not point the md2wechat installer at main"
! grep -q 'raw.githubusercontent.com/lexiaowenn/md2wechat-new/main/scripts/install.ps1' README.md || fail "README must not point the md2wechat installer at main"
! grep -q 'raw.githubusercontent.com/lexiaowenn/md2wechat-new/main/scripts/install-openclaw.sh' README.md || fail "README must not point the OpenClaw installer at main"
! grep -q 'raw.githubusercontent.com/lexiaowenn/md2wechat-new/main/scripts/install.sh' docs/INSTALL.md || fail "docs/INSTALL.md must not point the md2wechat installer at main"
! grep -q 'raw.githubusercontent.com/lexiaowenn/md2wechat-new/main/scripts/install.ps1' docs/INSTALL.md || fail "docs/INSTALL.md must not point the md2wechat installer at main"
! grep -q 'raw.githubusercontent.com/lexiaowenn/md2wechat-new/main/scripts/install-openclaw.sh' docs/OPENCLAW.md || fail "docs/OPENCLAW.md must not point the OpenClaw installer at main"
